...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <?php require_once "app/views/admin/kategori/addKategori.php"; ?>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        while ($dataKategori = $exeKategori->fetch_object()) { ?>
                            <tr>
                                ...
                                <td>
                                    <?php require "app/views/admin/kategori/editKategori.php"; ?>
                                    <a href="?page=Kategori&hapuskategori&id=<?= $dataKategori->idKategori ?>" class="btn btn-sm btn-warning mb-1"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
