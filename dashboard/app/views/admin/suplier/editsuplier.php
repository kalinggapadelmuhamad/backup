<a class="btn  btn-sm btn-info shadow-sm mb-1" data-toggle="modal" data-target="#editsupliermodal<?= $dataKategori->idKategori ?>"><i class="fas fa-edit"></i></a>
<div class="modal fade" id="editsupliermodal<?= $dataKategori->idKategori ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-sm btn-success" type="submit" name="suplier-update">Save</button>
                </div>
            </form>
        </div>
    </div>
